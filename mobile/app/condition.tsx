...
const riskGradient: Record<string, [string, string]> = {
  safe:     ['#6db33f', '#4e9a24'],
...
export default function Conditions() {
  ...
  const gradient = riskGradient[currentSensor.status] ?? riskGradient.caution
      ...
      <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.statusRow}>
            ...
            <LinearGradient colors={gradient} style={styles.statusCard}>
